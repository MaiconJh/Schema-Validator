...
Publishing workflow: [PUBLISHING](PUBLISHING).
...
## GitHub wiki indexing note

If the remote wiki currently indexes only `README`, publish this file first, then publish the linked pages (`Quickstart-and-Setup`, `Schema-and-Validator-Reference`, `Skript-Integration`, `Troubleshooting-and-FAQ`, `_Sidebar`).
